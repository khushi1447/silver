        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8 animate-fade-in">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Is it possible to tell whether the silver is authentic?</p>
                <p>
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Is it possible to have a delivery made to Ahmedabad?</p>
                <p>
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Is it possible for silver pendants to lose their luster?</p>
                <p>
